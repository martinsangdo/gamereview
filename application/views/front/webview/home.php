                    ...
                    <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg" id="navBar">
                        <ul class="navbar-nav g-font-weight-600">
                            ...
                            <li class="hs-has-mega-menu nav-item g-mx-10--lg g-mx-20--xl"
                                ...
                                data-position="right">
                                <a id="mega-menu-label-1" class="nav-link text-uppercase g-px-0" href="#!" aria-haspopup="true" aria-expanded="false">XBox
                            ...
                            <li class="hs-has-mega-menu nav-item g-mx-10--lg g-mx-20--xl"
                                ...
                                data-animation-out="fadeOut"
                                data-position="right">
                                <a id="mega-menu-label-5" class="nav-link text-uppercase g-px-0" href="#!" aria-haspopup="true" aria-expanded="false">Switch
                                    <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i></a>
                            ...
                            <li class="hs-has-mega-menu nav-item g-mx-10--lg g-mx-20--xl"
                                ...
                                data-animation-out="fadeOut"
                                data-position="right">
                                <a id="mega-menu-label-3" class="nav-link text-uppercase g-px-0" href="#!" aria-haspopup="true" aria-expanded="false">Wii U
                                    <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i></a>
                            ...
                            <li class="hs-has-mega-menu nav-item g-mx-10--lg g-mx-20--xl"
                                ...
                                data-animation-out="fadeOut"
                                data-position="right">
                                <a id="mega-menu-label-4" class="nav-link text-uppercase g-px-0" href="#!" aria-haspopup="true" aria-expanded="false">PS 3
                                    <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i></a>
                            ...
                            <li class="hs-has-mega-menu nav-item g-mx-10--lg g-mx-20--xl"
                                ...
                                data-animation-out="fadeOut"
                                data-position="right">
                                <a id="mega-menu-label-5" class="nav-link text-uppercase g-px-0" href="#!" aria-haspopup="true" aria-expanded="false">Xbox 360
                                    <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i></a>
                            ...
                            <li class="hs-has-mega-menu nav-item g-mx-10--lg g-mx-20--xl"
                                ...
                                data-animation-out="fadeOut"
                                data-position="right">
                                <a id="mega-menu-label-6" class="nav-link text-uppercase g-px-0" href="#!" aria-haspopup="true" aria-expanded="false">Android
                                    <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i></a>
                            ...
                            <li class="hs-has-mega-menu nav-item g-mx-10--lg g-ml-15--xl"
                                ...
                                data-animation-out="fadeOut"
                                data-position="right">
                                <a id="mega-menu-label-7" class="nav-link text-uppercase g-px-0" href="#!" aria-haspopup="true" aria-expanded="false">iOS
                                    <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i></a>
            ...
            <div class="row no-gutters">
                    ...
                    <article class="u-block-hover">
                        <figure class="u-shadow-v25 g-bg-cover g-bg-white-gradient-opacity-v1--after">
                            <div class="home1-center-cropped"
                                 style="background-image: url('<?php echo $block_key_1[0]->thumb_url;?>');">
                            </div>
                        </figure>
                    ...
                    <article class="u-block-hover">
                        <figure class="u-shadow-v25 u-bg-overlay g-bg-white-gradient-opacity-v1--after">
                            <div class="home2-center-cropped"
                                 style="background-image: url('<?php echo $block_key_1[2]->thumb_url;?>');">
                            </div>
                        </figure>
                ...
                <div class="col-lg-4 g-px-1--lg g-mb-30 g-mb-0--lg">
                    ...
                    <article class="u-block-hover">
                        <figure class="u-shadow-v25 u-bg-overlay g-bg-white-gradient-opacity-v1--after">
                            <div class="home2-center-cropped"
                                 style="background-image: url('<?php echo $block_key_1[3]->thumb_url;?>');">
                            </div>
                        </figure>
                ...
                <div class="col-lg-4 g-pl-1--lg">
                    ...
                    <article class="u-block-hover">
                        <figure class="u-shadow-v25 u-bg-overlay g-bg-white-gradient-opacity-v1--after">
                            <div class="home2-center-cropped"
                                 style="background-image: url('<?php echo $block_key_1[4]->thumb_url;?>');">
                            </div>
                        </figure>
