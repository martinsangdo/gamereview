...
//        $this->output->enable_profiler(TRUE);
    ...
    public function index(){
        ...
        $this->data[BLOCK_KEY_4] = $this->block_content_model->get_pagination_rand(array('site_id' => 7), 0, DEFAULT_PAGE_LEN);
        $this->data[BLOCK_KEY_5] = $this->block_content_model->get_pagination_rand(array('site_id' => 18), 0, DEFAULT_PAGE_LEN);
        $this->data[BLOCK_KEY_6] = $this->block_content_model->get_pagination_rand(array('site_id' => 9), 0, DEFAULT_PAGE_LEN);
        $this->data[BLOCK_KEY_7] = $this->block_content_model->get_pagination_rand(array('site_id' => 10), 0, DEFAULT_PAGE_LEN);
        $this->data[BLOCK_KEY_8] = $this->block_content_model->get_pagination_rand(array('site_id' => 11), 0, DEFAULT_PAGE_LEN);
        $this->data[BLOCK_KEY_9] = $this->block_content_model->get_pagination_rand(array('site_id' => 12), 0, DEFAULT_PAGE_LEN);
        $this->data[BLOCK_KEY_10] = $this->block_content_model->get_pagination_rand(array('site_id' => 13), 0, DEFAULT_PAGE_LEN);
        $this->data[BLOCK_KEY_11] = $this->block_content_model->get_pagination_rand(array('site_id' => 14), 0, DEFAULT_PAGE_LEN);
